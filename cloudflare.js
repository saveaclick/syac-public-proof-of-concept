...
const upstream_get_parameter = 'url_for_headline';
...
async function fetchAndApply(request) {
    ...
    let upstream_GET = (upstream_allow_override) ? url.searchParams.get(decodeURIComponent(upstream_get_parameter)) : null;
